...
export default function TicketApp() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AllModals
        {...{ modalState, closeModal, settingsData, setSettingsData, handleUpdateSettings, timeLogs, setTimeLogs }}
      />
      ...
      {modalState.type === 'newTicket' && ( <NewTicketModal onClose={closeModal} onSave={handleCreateTicket} newTicketData={newTicketData} setNewClientData={setNewTicketData} isEditingTicket={isEditingTicket} currentUser={currentUser} clientiAttivi={users.filter(u => u.ruolo === 'cliente')} selectedClientForNewTicket={selectedClientForNewTicket} setSelectedClientForNewTicket={setSelectedClientForNewTicket} /> )}
