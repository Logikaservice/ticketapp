...
import { Plus, LogOut, Settings, Users, UserPlus, List, Sparkles, Key, BarChart3, Activity, Clock, FolderOpen, Calendar, Volume2, Monitor, FileText, Table, Wifi, Server as ServerIcon, MapPin, Shield, AlertTriangle, AlertCircle, ChevronRight, Building2, Mail, Bell, Gauge, Eye, LockKeyhole, LayoutGrid } from 'lucide-react';
import AgentNotifications from './AgentNotifications';

const Header = ({ currentUser, handleLogout, openNewTicketModal, openNewClientModal, openSettings, openManageClientsModal, openAlertsHistory, openAnalytics, openAccessLogs, openInactivityTimer, openOrariTurni, openVivaldi = null, openPackVision, openTechnicianWorkbench = null, openCreateContract, openContractsList, openNetworkMonitoring, openNetworkMonitoringAgents, openNetworkMonitoringCreateAgent, openNetworkMonitoringDeviceTypes, openNetworkMonitoringNotifications, openNetworkMonitoringTelegram, openMappatura, openOffice, openAntiVirus, openEmail, openCommAgent, openCommAgentManager = null, openFlottaPC = null, openSpeedTest = null, openLSight = null, openVpnManager = null, isOrariDomain = false, getAuthHeader = null, socket = null }) => {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: Eye,
      color: 'indigo',
      visible: !isOrariDomain && (currentUser?.ruolo === 'tecnico' || isCompanyAdmin) && openLSight,
      onClick: () => handleQuickActionClick('lsight')
    },
    {
    ...
    // === Voci solo tecnico ===
    {
      ...
      subActions: [
        {
          label: 'Hub tecnico (beta)',
          icon: LayoutGrid,
          color: 'emerald',
          onClick: () => {
            if (openTechnicianWorkbench) openTechnicianWorkbench();
            setShowQuickActions(false);
            setExpandedAction(null);
            setExpandedSubAction(null);
          }
