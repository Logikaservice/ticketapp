...
import { ArrowLeft, ShieldCheck, X, RefreshCcw, Circle, Clock, KeyRound } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            ...
            <div className="text-slate-300 text-sm mt-1">
              In questa fase la pagina mostra solo il <span className="font-semibold">control-plane</span>. Il motore video/input WebRTC verrà aggiunto
