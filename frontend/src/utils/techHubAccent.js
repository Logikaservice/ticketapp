...
export function hubChromeCssVariables(surfaceMode = 'dark') {
  ...
  return {
    ...
    // Light-mode readability: keep muted texts darker to avoid "washed out" UI on white surfaces.
    '--hub-chrome-text-muted': 'rgba(55,65,81,0.90)',
    '--hub-chrome-text-faint': 'rgba(71,85,105,0.90)',
    '--hub-chrome-text-fainter': 'rgba(100,116,139,0.90)',
    '--hub-chrome-placeholder': 'rgba(100,116,139,0.72)',
