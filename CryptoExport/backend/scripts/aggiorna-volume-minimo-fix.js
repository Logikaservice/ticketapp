 ...
 * Versione con fix per assicurarsi che l'aggiornamento funzioni
 */
...
async function aggiornaVolumeMinimo() {
    ...
    try {
        ...
        // 1. Leggi i parametri attuali con transazione
        ...
        const botSettings = result.rows[0];
        ...
        // 3. Salva nel database con transazione
        ...
        if (verifyResult.rows && verifyResult.rows.length > 0) {
            ...
            if (verifiedParams.min_volume_24h === 1000000) {
                console.log('✅ Volume minimo aggiornato correttamente a 1,000,000 USDT!\n');
            } else {
                console.error('❌ ERRORE: Il valore non è stato aggiornato correttamente!');
                console.error('   Valore atteso: 1000000');
                console.error('   Valore trovato:', verifiedParams.min_volume_24h);
            }
        } else {
            console.error('❌ ERRORE: Impossibile verificare l\'aggiornamento');
        }
