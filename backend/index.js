...
// ✅ Endpoint pubblici per AI accesso database (PRIMA di cryptoRoutes, senza autenticazione)
...
// ✅ Endpoint pubblici per AI accesso database (PRIMA del middleware autenticazione)
app.get('/api/ai-db/execute', async (req, res) => {
    try {
        const { command } = req.query;
        const commands = {
